...
export const mediaItems: MediaItem[] = [
    ...
    {
        id: "eJWXd8rL87w",
        title: "کۆکراوەی وتار و بەسەرهاتەکانی مامۆستا عادل عیزەت جەباری",
        titleKu: "کۆکراوەی وتار و بەسەرهاتەکانی مامۆستا عادل عیزەت جەباری",
        channel: "قناة القرآن الكريم",
        channelKu: "قەناتی قورئانی پیرۆز",
        category: "lecture-ku",
        language: "ku",
    },
    {
        id: "uHwN47lH3ds",
        title: "بەهێزترین وتاری کوردی - ژیانت دەگۆڕێت",
        titleKu: "بەهێزترین وتاری کوردی - ژیانت دەگۆڕێت",
        channel: "ساتێک بۆ یادی خودا",
        channelKu: "ساتێک بۆ یادی خودا",
        category: "lecture-ku",
        language: "ku",
    },
    {
        id: "pvXSfI5t-BU",
        title: "چیرۆکی ژیانی پەیامبەر موسا علیه سلام و فرعەون",
        titleKu: "چیرۆکی ژیانی پەیامبەر موسا علیه سلام و فرعەون",
        channel: "Ozil Alan",
        channelKu: "ئۆزیل ئالان",
        category: "lecture-ku",
        language: "ku",
    },
    {
        id: "_T-ZegWSYao",
        title: "پەیامەکانی قورئان - زکری خودا زۆر بکە - مامۆستا محمد ملا فائق",
        titleKu: "پەیامەکانی قورئان - زکری خودا زۆر بکە - مامۆستا محمد ملا فائق",
        channel: "م.محمد ملا فائق شارەزووری",
        channelKu: "مامۆستا محمد ملا فائق شارەزووری",
        category: "lecture-ku",
        language: "ku",
    },
    ...
    {
        id: "R4C-wPKkfGg",
        title: "ئامۆژگارییەکانى پێغەمبەرى خودا ﷺ بۆ ئافرەتان-48",
        titleKu: "ئامۆژگارییەکانى پێغەمبەرى خودا ﷺ بۆ ئافرەتان-48",
        channel: "م.محمد ملا فائق شارەزووری",
        channelKu: "م.محمد ملا فائق شارەزووری",
        category: "podcast",
        language: "ku",
    },
    {
        id: "TRUGxTJc3gM",
        title: "مامۆستا قانع خورشید لە پۆدکاستی روانگە",
        titleKu: "مامۆستا قانع خورشید لە پۆدکاستی روانگە",
        channel: "Rwanga Foundation",
        channelKu: "Rwanga Foundation",
        category: "podcast",
        language: "ku",
    },
    {
        id: "PGcVDPQRmIs",
        title: "پەیامی ڕەمەزان | م.فەرهاد فاتیح | پۆدکاستی نما",
        titleKu: "پەیامی ڕەمەزان | م.فەرهاد فاتیح | پۆدکاستی نما",
        channel: "Nma Media",
        channelKu: "نما میدیا",
        category: "podcast",
        language: "ku",
    ...
    {
        id: "sKW1FR37BWM",
        title: "پۆدکاستی بونیاد - کاک بەختەوەر بەهائەدین - ژیان لەگەڵ قورئان",
        titleKu: "پۆدکاستی بونیاد - کاک بەختەوەر بەهائەدین - ژیان لەگەڵ قورئان",
        channel: "Bunyad",
        channelKu: "بونیاد",
        category: "podcast",
        language: "ku",
    ...
    {
        id: "3c1LauOZvS8",
        title: "بانگخواز و خیلاف و کاری بەکۆمەڵ | م.عبدالرحمان | پۆدکاستی نما",
        titleKu: "بانگخواز و خیلاف و کاری بەکۆمەڵ | م.عبدالرحمان | پۆدکاستی نما",
        channel: "Nma Media",
        channelKu: "نما میدیا",
        category: "podcast",
        language: "ku",
    ...
    {
        id: "Srwl1sBx4Ko",
        title: "مامۆستا ئەحمەدی شافعی: نهێنی خۆشبەختی، حەرام و حەڵاڵ! - پۆدکاستی دیوەخان",
        titleKu: "مامۆستا ئەحمەدی شافعی: نهێنی خۆشبەختی، حەرام و حەڵاڵ! - پۆدکاستی دیوەخان",
        channel: "The Diwaxan Podcast",
        channelKu: "The Diwaxan Podcast",
        category: "podcast",
        language: "ku",
    },
